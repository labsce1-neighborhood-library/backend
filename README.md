...
| GET    | `/user/id/:user_id`                          | Admin          | Finds user by user_id                                                                      |
| GET    | `/user/username/:username`                   | Admin          | Finds user by username                                                                     |
| GET    | `/user/firebase_id/:firebase_id`             | Admin          | Finds user by firebase_id                                                                  |
| GET    | `/user/email/:email`                         | Admin          | Finds user by email                                                                        |
| GET    | `/user/book_id/:book_id`                     | Admin          | finds user by book_id                                                                      |
| PUT    | `/user/:user_id`                             | All users      | Updates user                                                                               |
| GET    | `/user/location/:latitude/:longitude`        | Admin          | Gets list of users that have their location at that latitude and longitude                 |
| GET    | `/user/location/:latitude/:longitude/:range` | Admin          | Gets list of users that have their location within the range of the latitude and longitude |
| GET    | `/user/isbn/:isbn`                           | Admin          | Gets list of users that have that book                                                     |
| GET    | `/user/cc/:user_id`                          | Admin          | Gets cc info by user_id                                                                    |
